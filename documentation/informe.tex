...
Es dedueix, a partir de l'equació de recurrència creada pel arbre, que el nombre de nodes a recòrrer en funció de $n$ (on $n$ és el nombre de pilars) serà $2^{n-1}$.\\
\newpage
