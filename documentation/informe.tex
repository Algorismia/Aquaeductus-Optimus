...
\title{%
    ...
    \line(1,0){250}
    \\[0.5cm]
	\large Assignatura d'Algorítmica i complexitat del Grau d'Enginyería Informàtica
}
...
\subsection{Pseudocodi algorisme iteratiu}
...
\subsection{Pseudocodi algorisme recursiu}
