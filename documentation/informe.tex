...
\subsubsection{Empíric}
\begin{figure}[h!]
    \includegraphics[max size={\textwidth}{\textheight}]{backtracking-benchmark}
    \centering
    \caption{Cost empíric en Python}
